...
export const strategies = [
  ...
  },
  {
    ...
    description: "Weekly long-only breakout. Fires on 8-week high-of-closes with weekly EMA10>EMA30. Exits on weekly close below EMA10 or -2x ATR stop. No fixed TP - catches full cyclic bull waves.",
    category: "Momentum",
    risk: "medium" as const,
    returnRate: 112.3,
    winRate: 70,
    ...
    minInvestment: 500,
    pairs: ["BTC/USDT", "ETH/USDT", "SOL/USDT"],
    performance: Array.from({ length: 30 }, (_, i) => ({ day: i + 1, value: 100 + i * 2.8 + Math.cos(i * 0.25) * 4 })),
    tags: ["Weekly", "Breakout"],
  },
]
