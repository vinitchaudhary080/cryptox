        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6">
          <motion.div initial="hidden" animate="visible" variants={stagger}>
            ...
            <motion.p variants={fadeUp} className="mt-6 leading-relaxed text-muted-foreground">
              Welcome to AlgoPulse. By creating an account or using our platform, you agree to these terms.
          ...
          <motion.div initial="hidden" animate="visible" variants={stagger} className="mt-12 space-y-10">
            <motion.div variants={fadeUp}>
              ...
              <div className="space-y-3 text-muted-foreground leading-relaxed">
                <p>By accessing or using AlgoPulse, you agree to be bound by these Terms of Service and our <Link href="/privacy" className="text-primary hover:underline">Privacy Policy</Link>. If you do not agree to these terms, do not use our platform.</p>
                <p>You must be at least 18 years old and legally permitted to trade cryptocurrency in your jurisdiction to use AlgoPulse.</p>
              </div>
            </motion.div>
            ...
            <motion.div variants={fadeUp}>
              ...
              <div className="space-y-3 text-muted-foreground leading-relaxed">
                <p>AlgoPulse is an algorithmic trading platform that allows you to deploy pre-built trading strategies, backtest strategies against historical data, and monitor live trades across supported cryptocurrency exchanges.</p>
                <p>AlgoPulse is <Strong>not a broker, exchange, or financial advisor</Strong>. We provide software tools that connect to third-party exchanges via API. All trades are executed on your exchange account, and your funds remain on the exchange at all times.</p>
              </div>
            </motion.div>
            ...
            <motion.div variants={fadeUp}>
              ...
              <div className="space-y-3 text-muted-foreground leading-relaxed">
                ...
                <p>AlgoPulse stores your API keys in encrypted form and uses them solely to execute trades and retrieve account data on your behalf. We never access or move your funds.</p>
            ...
            <motion.div variants={fadeUp}>
              ...
              <div className="space-y-3 text-muted-foreground leading-relaxed">
                <p>AlgoPulse offers Free, Pro, and Max subscription plans. Each plan has different feature limits as described on our pricing page.</p>
            ...
            <motion.div variants={fadeUp}>
              ...
              <div className="space-y-3 text-muted-foreground leading-relaxed">
                <p>You agree not to: (a) use AlgoPulse for any illegal activity, including market manipulation, (b) attempt to reverse-engineer, decompile, or extract source code from the platform, (c) share your account with others or resell access, (d) use automated tools to scrape or extract data from AlgoPulse, or (e) intentionally disrupt or overload our servers or services.</p>
              </div>
            </motion.div>
            ...
            <motion.div variants={fadeUp}>
              ...
              <div className="space-y-3 text-muted-foreground leading-relaxed">
                <p>AlgoPulse is provided &quot;as is&quot; without warranty of any kind. We do not guarantee uninterrupted or error-free service, successful trade execution, or profitable trading outcomes.</p>
                <p>To the maximum extent permitted by law, AlgoPulse shall not be liable for any indirect, incidental, special, or consequential damages, including trading losses, lost profits, or data loss, arising from your use of the platform.</p>
                <p>Our total liability for any claim arising from your use of AlgoPulse shall not exceed the amount you paid us in the 12 months preceding the claim.</p>
              </div>
            </motion.div>
            ...
            <motion.div variants={fadeUp}>
              ...
              <div className="space-y-3 text-muted-foreground leading-relaxed">
                ...
                <p>Your continued use of AlgoPulse after updated terms take effect constitutes acceptance of those terms.</p>
              </div>
            </motion.div>
